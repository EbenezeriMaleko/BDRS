                                    ...
                                    <div class="detail-box">
                                        <div>
                                            <h1>
                                                Welcome To <br>
                                                <span>
                                                    Business Data Record System
                                                </span>
                                            </h1>
                                            <p>
                                                It has been a great commision to offer you with perfect recording book
                                                for your own business where you
                                                can record your materials
                                            </p>
                                            <div class="btn-box">
                                                <a href="loginPage.php" class="btn-1">
                                                    GET STARTED
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-7">
                                    <div class="detail-box">
                                        <div>
                                            ...
                                            <p>
                                                where you can keep your document safe
                                            </p>
                                            <div class="btn-box">
                                                <a href="loginPage.php" class="btn-1">
                                                    GET STARTED
